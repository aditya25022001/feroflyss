...
export const Wifi = () => {
    return (
        <div style={{ width:'5vh', height:'5vh' }}>
            <svg preserveAspectRatio="xMidYMid meet" data-bbox="9.087 39.3 182.438 121.4" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="9.087 39.3 182.438 121.4" role="img"><g><ellipse cx="100.3" cy="154.5" rx="6.2" ry="6.2"></ellipse><path d="M190.7,77c-23.9-24.3-55.8-37.7-89.8-37.7c-34.6,0-67,13.9-91,39.1c-1.1,1.1-1.1,3,0.1,4.1c0.6,0.5,1.3,0.8,2,0.8
