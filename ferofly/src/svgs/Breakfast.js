...
export const Breakfast = () => {
    return (
        <div style={{ width:'5vh', height:'5vh' }}>
           <svg preserveAspectRatio="xMidYMid meet" data-bbox="6.3 27 187.7 145" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="6.3 27 187.7 145" role="img">
               <g>
                   <path d="M176.1,70l-6.1,0v-8H58v35.8c0,2.8,0.8,5.4,1.2,8.1c-17.6,3-26.4,13.5-26.8,14.1c-0.6,0.8-0.6,1.8-0.1,2.6l1.1,1.9
