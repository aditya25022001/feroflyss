...
export const HouseKeeping = () => {
    return (
        <div style={{ width:'4vh', height:'4vh' }} className='mb-3'>
           <svg preserveAspectRatio="xMidYMid meet" data-bbox="29 4.9 144 190.1" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="29 4.9 144 190.1" role="img"><g><path d="M160.2,63.5L103,44c0,0,0-4,0-4c8.6-5.4,15.6-9.8,15.6-18.6c0-9.1-7.4-16.5-16.5-16.5s-16.5,7.4-16.5,16.5
	...
	c0-4.3,3.2-7.4,9.4-9.5L100,48h1l57.5,20.5c6.1,2.1,9.5,6.2,9.5,10.5C168,84.3,163.3,88,158,88z"></path></g></svg> 
        </div>
    )
}
